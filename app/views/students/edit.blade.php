...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            {{ Form::model($student, ['route' => ['cp.students.update', $student->id], 'method' => 'put', 'id' => 'addStudentForm']) }}
                <div class="row">
                    <!-- student form -->
                    <div class="col-md-6">
...
<!--                            <input type="text" name="first_name" class="form-control">-->
                        ...
                        <div class="form-group @if($errors->first('sub_district_id')) has-error @endif">
                            ...
                            {{ Form::select('sub_district_id', $sub_district_lists, $student->people->village->sub_district->id, ['id' => 'subDistrict', 'class'=> 'form-control']) }}
                        ...
                        <div class="form-group @if($errors->first('village_id')) has-error @endif">
                            ...
                            <select class="form-control" name="village_id" id="villageId" disabled="disabled" data-id="@if(Input::old('village_id')){{Input::old('village_id')}}@elseif($village_id=$student->people->village_id){{$village_id}}@endif">
                    ...
                    <div id="univercityForm" class="col-md-6" style="background: #f5f5f5;">
                       <h3>Univercity / College Details</h3>
                           ...
                           <div class="form-group @if($errors->first('univercity')) has-error @endif">
                            ...
                            {{ Form::text('univercity', $student->univercity->name, ['id' => 'univercity', 'class' => 'form-control']) }}
                            ...
                            @endif
                            <input type="hidden" name="univercity_id" id="univercityId" value="@if(Input::old('univercity_id')){{Input::old('univercity_id')}}@elseif($univercity_id=$student->univercity->id){{$univercity_id}}@endif">
                        </div>
                        
                        <div class="form-group @if($errors->first('univercity_type')) has-error @endif">
                            <label for="type">Public / Private</label>
                            {{ Form::select('univercity_type', $univercity_type_lists, $student->univercity->type, ['id' => 'univercityType', 'class' => 'form-control univercity-details']) }}
                        ...
                        <div class="form-group @if($errors->first('univercity_province_id')) has-error @endif">
                            ...
                            {{ Form::select('univercity_province_id', $province_lists, $student->univercity->city->province->id, ['id' => 'univercityProvinceId', 'class'=> 'form-control univercity-details']) }}
                        ...
                        <div class="form-group @if($errors->first('univercity_city_id')) has-error @endif">
                            ...
                            <select  name="univercity_city_id" id="univercityCityId" class="form-control univercity-details" data-id="@if(Input::old('univercity_city_id')){{Input::old('univercity_city_id')}}@elseif($univ_city_id=$student->univercity->city_id){{$univ_city_id}}@endif">
                        ...
                        <div class="form-group @if($errors->first('faculty')) has-error @endif">
                            ...
                            <input type="text" name="faculty" id="faculty" class="form-control" value="{{$student->major->faculty->name  }}">
                            <small class="help-block">Tips: Wait a moment for suggestions</small>
                            @if($errors->first('faculty'))
                                <span class="help-block"> {{ $errors->first('faculty') }} </span>
                            @endif
                            <input type="hidden" name="faculty_id" value="{{ $student->major->faculty->id }}">
                        </div>
                        
                        <div class="form-group @if($errors->first('major')) has-error @endif">
                            <label for="major">Major</label>
                            <input type="text" name="major" id="major" class="form-control" value="{{ $student->major->name }}">
                            <small class="help-block">Tips: Wait a moment for suggestions</small>
                        ...
                        <div class="form-group @if($errors->first('degree_id')) has-error @endif">
                            ...
                            {{ Form::select('degree_id', $degree_lists, $student->degree_id, ['class' => 'form-control']) }}
                        ...
                        <div class="form-group @if($errors->first('year')) has-error @endif">
                            ...
                            {{ Form::text('year', $student->year, ['class' => 'form-control']) }}
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::select('type', ['regular' => 'Regular', 'non_regular' => 'Non-Regular'], $student->type, ['class'=> 'form-control']) }}
                        ...
                        <div class="form-group input-group @if($errors->first('amount_of_grant')) has-error @endif">
                            ...
                            {{ Form::text('amount_of_grant', $student->amount_of_grant, ['class' => 'form-control', 'placeholder' => 'Amount of grant']) }}
